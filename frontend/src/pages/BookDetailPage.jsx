...
const BookDetailPage = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-base-200 flex items-center jsutify-center">
    ...
    <div className="min-h-screen bg-base-200">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          {/* Header */}
          <div className="flex items-center jsutify-betweeen mb-6">
            <Link to="/" className="btn btn-ghost">
              <ArrowLeftIcon className="h-5 w-5" />Back to Book
            </Link>
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              ...
              <div className="form-control mb-4">
                ...
                <input type="text" placeholder="Book title" className="input     input-borderd" value={book.title} onChange={(e) => setBook({ ...book, title: e.target.value })} />
              </div>
              {/* AUTHOR */}
              <div className="form-control mb-4">
                <label className="label">
            ...
            <div className="form-control mb-6">
              ...
              <input type="number" placeholder="Year" className="input input-borderd" value={book.publishYear} onChange={(e) =>
                setBook({ ...book, publishYear: e.target.value })} /></div>
            {/* ACTION */}
